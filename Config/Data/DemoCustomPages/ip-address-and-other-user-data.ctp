...
(directly, a serach engine, referal link etc) is a crtical piece in gathering
the needed data to properly analyze your traffic. This data can help you make
better decisions to help improve your overall user experiance. Today I'll show
you how to get the data. Later we will discuss how to build some simple reports.
</p>

<h2>Your IP Adrress</h2>

<p><b><?php echo $_SERVER['REMOTE_ADDR']; ?></b></p>

<p>
On the surface this may not seem ver usefull, but it does have value. First
this enables you to remove data about you hitting your own page. This will
give you a view of just you vistors. Another great use is matching duplicate
...
for this, but I could see where some may find it usefull.
</p>
...
work. In this case I use the browser details to decide which stylesheet or
front end hack I need to serve up.
</p>

<p>To me, this also answers the question; Do we really need to support that
browser? IE8 will be comming out soon, this has many developers rejoycing.
...
<h2>Referer (How you got here)</h2>
<p>
    <b>
    <?php
...
campaigns, referal links, and your traffics origin in general. By analyizing
the urls from search engines you can even deteremine the key words used to
find your site.
</p>
<a href="/portals/code/ip-address-and-other-user-data.txt" target="_blank">Plain Text</a>
...
<a href="/posts/2008/10/building-traffic-reports">building traffic reports</a>
</p>
