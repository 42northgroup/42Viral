...
Configure::write('Twitter', array(
    ## 'consumer_key' => '',
    ## 'consumer_secret' =>'',
    ## 'callback' => Configure::read('Domain.url') . 'oauth/twitter_callback',
    'Schema' => array(
        'consumer_key' => array(),
        'consumer_secret' => array(),
        'callback' => array('validate' => array('url')),
    )
));
...
Configure::write('LinkedIn', array(
    ## 'consumer_key' => '',
    ## 'consumer_secret' =>'',
    ## 'callback' => Configure::read('Domain.url') . 'oauth/linkedin_callback',
    'Schema' => array(
        'consumer_key' => array(),
        'consumer_secret' => array(),
        'callback' => array('validate' => array('url')),
...
Configure::write('Facebook', array(
    ## 'consumer_key' => '',
    ## 'consumer_secret' =>'',
    ## 'callback' => Configure::read('Domain.url') . 'oauth/facebook_callback',
    'Schema' => array(
        'consumer_key' => array(),
        'consumer_secret' => array(),
        'callback' => array('validate' => array('url')),
