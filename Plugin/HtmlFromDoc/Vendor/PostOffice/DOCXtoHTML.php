                ...
                switch ($value['tag']) {
                        ...
                        if($this->doImages) {
                            if($value['type'] == "open" || $value['type'] == "complete"){
                                ...
                                if($this->keepOriginalImage == true && $imagebigpath){
                                    $html4output .= "<a href='".$this->imagePathPrefix.$imagebigpath."' target='_blank' >
                                        <img style='display:inline;' src='".$this->imagePathPrefix.$imagepath."' alt='' />
                                        </a>";
                                } else {
                                    $html4output .= "<img style='display:inline;' src='".$this->imagePathPrefix.$imagepath."' alt='' />";
                                }
                            }
                        }
                        break;
                    ...
                    case "W:COLOR":
                        if($value['type'] == "complete" && $this->allowColor){
                            $html4output .= "<span style='color:#".$value['attributes']['W:VAL'].";'>";//add colored text
                            $this->tagcloset = "</span>";
                        }
                        break;
                    case "V:TEXTPATH":
                    ...
                    case "W:U"://word style for underline
                        if($value['type'] == "complete"){
                            ...
                            $html4output .= "<span style='text-decoration:underline;'>";//return the text (add spaces after)
                            $this->tagcloset = "</span>";
                        }
                        break;
                    case "W:STRIKE"://word style for strike-throughs
                        if($value['type'] == "complete"){
                            ...
                            $html4output .= "<span style='text-decoration:line-through;'>";//return the text (add spaces after)
                            $this->tagcloset = "</span>";
                        }
                        break;
