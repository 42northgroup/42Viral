...
class FileUploadComponent extends Component
{
    ...
    /**
     * Skip creating an entry in the uploads table even if the model exists
     *
     * @var boolean
     */
    ...
    function _processFile()
    {
        ...
        if (move_uploaded_file($this->uploadedFile['tmp_name'], $target_path)) {
            ...
            if (!$this->skipModel) {
                ...
                $saveData[$this->fields['name']] = $this->finalFile;
                $saveData[$this->fields['type']] = $this->uploadedFile['type'];
                $saveData[$this->fields['size']] = $this->uploadedFile['size'];

                if (!$model || $model->save($saveData)) {
                    $this->success = true;
                } else {
                    $this->success = false;
                }
    ...
    function _checkType()
    {
        /* Currently we have decided to accept anything a user wants to upload.
