 ...
 * @license      MIT
 */
//App::uses('Vendor', 'FileUpload.Uploader');
//App::uses('Config', 'FileUpload.FileUploadSetting');

App::uses('Uploader', 'FileUpload.Vendor');
App::uses('FileUploadSetting', 'FileUpload.Config');
...
class FileUploadComponent extends Component
{
    ...
    public function initialize(&$controller)
    {
        ...
        $this->options = array_merge($fileUploadSetting->defaults, $this->options);
    }
     ...
     */
    private function __prepareSaveData()
    {
        $retval = array();
     ...
     * @return void
     */
    private function _setCurrentFile($file)
    {
        if ($this->options['fileModel']) {
     ...
     * @access protected
     */
    protected function _uploadedFilesArray()
    {
        $retval = array();
     ...
     * @access protected
     */
    protected function _multiArrayKeyExists($needle, $haystack)
    {
