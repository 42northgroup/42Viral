...
class FileUploadHelper extends AppHelper
{
    ...
    {
        $this->FileUploadSetting = new FileUploadSetting();
        $this->Html = new HtmlHelper();
        $this->Form = new FormHelper();

        //setup settings
        $this->settings = array_merge($this->FileUploadSetting->defaults, $this->options);
    }
    ...
    {
        $options = array_merge(
                array('var' => $this->settings['fileVar'], 'model' => $this->settings['fileModel']), $options
        );
        $configs = $options;
        if ($configs['model']) {
     ...
     * @access protected
     */
    protected function _getImageById()
    {
     ...
     */
    protected function _getImageByName()
    {
     ...
     * @access protected
     */
    protected function _getResizeNameOrPath($file_name_or_path)
    {
     ...
     */
    protected function _isOutsideSource()
    {
