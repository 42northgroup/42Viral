 ...
 *
 * Copyright (c) 2008 Jason D Snider. All rights reserved
 *
 * Licensed under The MIT License
...
$you['referer'] = (isset($_SERVER['HTTP_REFERER'])?$_SERVER['HTTP_REFERER']:'Direct Hit');
...
$_BODY = <<<EOF
    <p>
     Yesterday, in my <a href="/post/tracking-ip-addresses-and-other-user-data">
    ...
    <td>http://www.jasonsnider.com/post/multiplatform-development-and-testing</td>
