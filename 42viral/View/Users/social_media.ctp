...
<div class="row">
    <div class="two-thirds column alpha">
        ...
        <?php echo $this->Html->image("/img/graphics/social_media/production/twitter32.png", array(
            'class' => 'mediaIcon',
            'data-color' => '#4099FF',
            'id' => 'TwitterIcon'
        )); ?>
        ...
        <?php echo $this->Html->image("/img/graphics/social_media/production/facebook32.png", array(
            'class' => 'mediaIcon',
            'data-color' => '#3B5998',
            'id' => 'FacebookIcon'
        )); ?>
        ...
        <?php echo $this->Html->image("/img/graphics/social_media/production/linkedin32.png", array(
            'class' => 'mediaIcon',
            'data-color' => '#006699',
            'id' => 'LinkedinIcon'
        )); ?>
